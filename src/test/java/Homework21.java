...
public class Homework21 extends BaseTest {
   ...
   private void contextClickPlayList() throws InterruptedException {
        ...
        WebElement rightClickPlaylist = getDriver().findElement(By.cssSelector(".playlist:nth-child(3)"));
    ...
    public boolean doesPlaylistExist(){
       WebElement playListElement = getDriver().findElement(By.xpath("//a[text()='"+playlistName+"']"));
