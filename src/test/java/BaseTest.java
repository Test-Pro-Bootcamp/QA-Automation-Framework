...
public class BaseTest {
    ...
    public static void provideEmail(String email){
      ...
      //  emailField.sendKeys(email);
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@type='email']"))).sendKeys(email);
    }
    public static void providePassword(String password){
       /* WebElement passwordField = driver.findElement(By.xpath("//*[@type='password']"));
        passwordField.clear();
        passwordField.sendKeys(password);*/
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@type='password']"))).sendKeys(password);
    }
