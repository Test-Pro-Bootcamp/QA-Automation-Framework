...
//       first  approach - Print current url
        String retrievedUrl = driver.getCurrentUrl();
        System.out.println("Our current URL is " +retrievedUrl);

//       another approach - assert if the current url is equal to your stored (String)  registration page url
        Assert.assertEquals(driver.getCurrentUrl(), registrationURL);

//       another approach - check if the "Register new account" text/line which can be found in the registration page is displayed in the current web page
